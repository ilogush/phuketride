-- Migration: Remove citizenship field from users table
-- Date: 2026-03-04

-- Create new users table without citizenship field
...
-- Copy data from old table to new table (excluding citizenship)
