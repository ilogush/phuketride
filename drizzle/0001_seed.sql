...
INSERT INTO districts (id, name, location_id, delivery_price, created_at, updated_at) VALUES
...
-- Insert test users
-- Password for admin: "220232", others: "password123" (in real app, this should be hashed)
INSERT INTO users (id, email, role, name, surname, phone, whatsapp, telegram, citizenship, city, country_id, gender, is_first_login, created_at, updated_at) VALUES
...
INSERT INTO companies (id, name, owner_id, email, phone, telegram, location_id, district_id, street, house_number, address, island_trip_price, krabi_trip_price, baby_seat_price_per_day, settings, created_at, updated_at) VALUES
...
-- Insert company cars
INSERT INTO company_cars (id, company_id, template_id, color_id, license_plate, year, transmission, engine_volume, fuel_type, price_per_day, deposit, min_insurance_price, max_insurance_price, mileage, oil_change_interval, status, photos, description, marketing_headline, seasonal_prices, created_at, updated_at) VALUES
