...
1. Upgrade:
   - `react-router` and `@react-router/dev` 7.13.1
...
## Maintenance Wave: Node 25 & Cleanup ✅
1. Upgrade `@types/node` to ^25.3.5.
2. Centralize quality checks in `npm run pre-launch:deploy`.
3. Update CI/Deploy GitHub workflows to Node 25.
