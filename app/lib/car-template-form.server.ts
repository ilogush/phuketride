...
const carTemplateFormSchema = z.object({
    ...
    transmission: z.enum(["automatic", "manual"] as const, { message: "Transmission is required" }),
    ...
    feature_transmission: z.enum(["automatic", "manual"] as const).optional().nullable(),
    ...
    drivetrain: z.enum(["FWD", "RWD", "AWD", "4WD"] as const).optional().nullable(),
    luggage_capacity: z.enum(["small", "medium", "large"] as const).optional().nullable(),
