...
export const inputStateModifiers = 'read-only:bg-gray-100 read-only:text-gray-500 read-only:cursor-not-allowed read-only:border-gray-200 disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed disabled:border-gray-200'
