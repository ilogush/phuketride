                    ...
                    <Form method="post" className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                autoComplete="email"
                                required
                                className="w-full px-4 py-2.5 rounded-xl bg-white text-gray-800 font-medium placeholder:text-gray-400 focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-300"
                        ...
                        <button
                            ...
                            className="group relative w-full bg-gray-900 hover:bg-black text-gray-500 font-bold py-4 rounded-2xl transition-all duration-300 shadow-xl shadow-gray-200 hover:shadow-gray-300 disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden"
                        >
