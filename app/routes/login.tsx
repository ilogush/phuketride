                    ...
                    <Form method="post" className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                autoComplete="email"
                                required
                                className="w-full px-5 py-4 rounded-2xl border border-gray-100 bg-gray-50/50 text-gray-900 font-medium placeholder:text-gray-400 focus:bg-white focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-300"
