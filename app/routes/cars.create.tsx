            ...
            <Form id="create-car-form" method="post" className="space-y-4">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <input type="hidden" name="greenBookPhotos" value={JSON.stringify(greenBookPhotos)} />
                        <input type="hidden" name="insurancePhotos" value={JSON.stringify(insurancePhotos)} />
                        <input type="hidden" name="taxRoadPhotos" value={JSON.stringify(taxRoadPhotos)} />
                    ...
                    <div className="space-y-4 lg:sticky lg:top-4 h-fit">
                        ...
                        <AdminCard title="Details" icon={<DocumentTextIcon className="w-5 h-5" />}>
                            <div className="space-y-4">
                                <Input
                        ...
                        <AdminCard title="Photos" icon={<PhotoIcon className="w-5 h-5" />}>
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <h4 className="block text-sm text-gray-500 mb-1">Green Book / Blue Book</h4>
                                ...
                                <div className="space-y-2">
                                    <h4 className="block text-sm text-gray-500 mb-1">Insurance</h4>
                                    <DocumentPhotosUpload
                                        currentPhotos={[]}
                                ...
                                <div className="space-y-2">
                                    <h4 className="block text-sm text-gray-500 mb-1">Tax Road</h4>
                                    <DocumentPhotosUpload
                                        currentPhotos={[]}
