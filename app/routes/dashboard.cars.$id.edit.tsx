...
export async function action({ request, context, params }: ActionFunctionArgs) {
    ...
    const rawData = {
        ...
        dailyMileageLimit: formData.get("dailyMileageLimit") ? Number(formData.get("dailyMileageLimit")) : car.dailyMileageLimit,
        ...
        minInsurancePrice: formData.get("minInsurancePrice") ? Number(formData.get("minInsurancePrice")) : car.minInsurancePrice,
        maxInsurancePrice: formData.get("maxInsurancePrice") ? Number(formData.get("maxInsurancePrice")) : car.maxInsurancePrice,
    };
                    ...
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            <Input
                                ...
                                type="number"
                                min={0}
                                defaultValue={car.dailyMileageLimit || ""}
                                addonRight="km/day"
                            />
                            <Input
