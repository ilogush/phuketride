            ...
            <form id="payment-type-form" onSubmit={handleSubmit} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        className={`block w-full rounded-xl border border-gray-200 sm:text-sm py-2 px-3 bg-white text-gray-700 focus:ring-0 focus:border-gray-500 focus:outline-none transition-colors ${errors.name ? 'border-gray-600' : ''
                            }`}
                ...
                <div>
                    ...
                    <select
                        ...
                        className={`block w-full rounded-xl border border-gray-200 sm:text-sm py-2 px-3 bg-white text-gray-700 focus:ring-0 focus:border-gray-500 focus:outline-none transition-colors ${errors.sign ? 'border-gray-600' : ''
