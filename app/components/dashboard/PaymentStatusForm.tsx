            ...
            <form id="payment-status-form" onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <select
                        ...
                        value={formData.value}
                        onChange={handleChange}
                        className={`block w-full rounded-lg border border-gray-200 sm:text-sm py-2 px-3 bg-white text-gray-900 focus:ring-0 focus:border-gray-500 transition-colors ${errors.value ? 'border-gray-600' : ''
                            }`}
                    >
